...
rest of it is built.
  ...
  .venv/bin/python3 scripts/diagnostics/forward_model/ftm_uses_z.py --ckpt wm/runs/beh12_body_fwd/best.pt
"""
import argparse
import glob
import os
...
def main():
    ...
    ap.add_argument("--dirs", nargs="+",
                    default=["hexapod=data/allocentric/beh12_c10f10t10_flat", "b1=data/allocentric/beh12_b1_flat"])
