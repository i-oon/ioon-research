...
failures and says nothing. At nine both are positive and the comparison means something.
  ...
  .venv/bin/python3 scripts/diagnostics/cross_embodiment/fit_b1_head.py --ckpt wm/runs/s1_fwd_m3d_cross/best.pt
"""
import argparse
import glob
import os
...
def condition_groups(paths):
    ...
    `_vx` filename convention of `data/allocentric/fwd_b1_50hz`, which predates that field and carries commanded
