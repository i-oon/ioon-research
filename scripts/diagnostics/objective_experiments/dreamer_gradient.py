"""Does the gradient through the world model's imagined rollout point the right way in the real world?
    ...
    .venv/bin/python3 scripts/diagnostics/objective_experiments/dreamer_gradient.py \\
...
from diagnostics.planning.teacher_label_quality import EGO_CAM, channels_of  # noqa: E402
