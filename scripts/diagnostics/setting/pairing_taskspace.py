...
columns are reported, or the trade is invisible.
  ...
  .venv/bin/python3 scripts/diagnostics/setting/pairing_taskspace.py
  .venv/bin/python3 scripts/diagnostics/setting/pairing_taskspace.py --phase_bins 8 --froude_bins 4
"""
import argparse
import glob
import os
...
def main():
    ...
    ap.add_argument("--hexapod_dir", default="data/allocentric/fwd_m3d")
    ap.add_argument("--b1_dir", default="data/allocentric/fwd_b1_50hz")
