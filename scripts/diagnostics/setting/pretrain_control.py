...
Run on com7; encoding plus two arms is over an hour of GPU.
  ...
  .venv/bin/python3 -u scripts/diagnostics/setting/pretrain_control.py --clips 100 --steps 6000
"""
import argparse
import glob
import os
...
def main():
    ...
    print(f"  .venv/bin/python3 -u scripts/diagnostics/cross_embodiment/finetune_ftm.py "
