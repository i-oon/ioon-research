"""Does the student's pooling throw away the thing that makes egocentric work?
    ...
    .venv/bin/python3 scripts/diagnostics/egocentric_view/pooled_student_check.py \\
...
from diagnostics.objective_experiments.residual_structure import FAMILY, gram, ridge_r2  # noqa: E402
