...
it is, and training a policy on the states it reaches is the fix that follows.
    ...
    .venv/bin/python3 scripts/diagnostics/planning/loop_frames_are_off_manifold.py \\
        results/wm/closed_loop/b1_physics3/*.npz --data data/allocentric/beh12_b1_flat --embodiment b1
"""
import argparse
import glob
import os
...
def main():
    ...
    ap.add_argument("--projector", default="wm/runs/beh12_hexonly/projector_stage3_nce_s0.pt")
