...
Three gates, following F69:
  ...
  .venv/bin/python3 scripts/diagnostics/channel_screen.py --ckpt wm/runs/stage2speed7body/last.pt
"""
import argparse
import glob
import os
...
def main():
    ...
    sources = (("insect", insect_paths(os.path.join(ROOT, args.insect_dir)), "head"),
               ("b1", sorted(glob.glob(os.path.join(ROOT, "data/b1_framed/*.npz"))), "base_pos"))
    data = {}
