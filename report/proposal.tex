...
per-embodiment head. Not pictured: the shared cross-body head trained alongside this loop (Section 3.4.4), which
...
that Chapter 4 shows actually carries the cross-embodiment claim: the shared cross-body head. A further module,
...
\subsection{Cross-Body Head: the module that carries the cross-embodiment claim}
...
\subsection{Setup}
The shared cross-body head of Section 3.4.4, trained with $\lambda_{\text{body}}=0.5$ across both embodiments,
...
cross-body head (Section 3.4.4), trained with no morphology label and no kinematic model for either the hexapod
