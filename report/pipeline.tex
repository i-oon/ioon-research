...
\node[font=\scriptsize, text=ink!75, above=2.0mm of z]
  ...
  \coordinate (ctxToMd) at (128,-9);
  \draw[clearline] (ctxToMd) -- (128,-25.8) -- ($(md.west)+(0,-2.8)$);
...
\node[font=\scriptsize, text=targetgray, anchor=east] at (238,-41)
  ...
  \begin{scope}[yshift=-100mm]
    ...
    \coordinate (ftCtxToMd) at (128,-9);
    \draw[clearline] (ftCtxToMd) -- (128,-25.8) -- ($(ftMd.west)+(0,-2.8)$);
