...
turning result meaningless (F106, F108). On-screen sense is the right language for this because both
...
| | |
|---|---|
| B1 framing | the robot touched an image edge in 61% of frames and 100% of every sideways clip; now 0%, at a 24-degree camera with the floor enlarged and its surface put back at z=0 (F104) |
| B1 camera pinning | every clip carried its own background; now consistent to 0.26 grey levels against the insect's 0.14 (F104) |
| B1 turn levels | `turn_wz0.00` was the forward clip under another name; replaced by four real levels named for the rate they achieve (F105) |
| turn direction | all three sets flipped onto the pretraining body's sense (F106, F108) |
