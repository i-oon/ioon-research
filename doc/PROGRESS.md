...
ขนาดตัวได้ (F56) เพราะฉะนั้นความเร็วข้ามร่างวัดได้จริง ไม่ใช่ `n/a` อย่างที่เขียนไว้ตอนแรก **เจ็ดเป้าหมาย
...
หมวดหมู่ ซึ่งเป็นสิ่งที่การเลื่อนของลำตัวในภาพพาข้ามไปได้ (F111)
...
**สิ่งที่ทำให้ข้ามร่างได้คือ contrastive term ในขั้น adapt** ซึ่งเป็นกลไกเดียวกับ F98 ที่เคยวัดบนคลิป
...
ว่า latent ข้ามร่างได้เอง (F112)
...
ของฝั่ง InfoNCE คือได้มากกว่า 25% แล้วยังแพ้** (F112)

**และวัดความกว้างปิดท้าย** MuJoCo ทำซ้ำได้บิตต่อบิต (F105) เพราะฉะนั้นความกระจายต้องมาจากคลิป
...
รอบเส้นสุ่ม 33 ส่วน MSE ได้ 2% ซึ่งต่ำกว่าสุ่มมาก คือหลีกเลี่ยงท่าเลี้ยวอย่างเป็นระบบ (F112)
...
**แต่มันทำให้ทุกตัวเลขฝั่ง B1 กลายเป็นผลชั่วคราวจนกว่าจะเรนเดอร์ใหม่** (F113)
...
เปลี่ยนป้าย เพราะได้สมดุลกลับมาและขยายช่วงการเลี้ยวของ B1 ให้เกินของแมลง ซึ่งตอนนี้กลับกันอยู่ (F114)
...
**F94 มีข้อมูลนี้อยู่แล้วแต่ปล่อยช่องตารางว่าง** — มันจับการกลับทิศของการเดินข้างได้และรายงานเป็นหัวข้อ
...
เดียวกับที่ F72 ปฏิเสธ Euler angles ตั้งแต่แรก **ตัวที่ตอบได้คือวาดเส้นทางแล้วดู**
