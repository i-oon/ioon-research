...
`results/wm/dataset/preview_beh12/` แล้วทักว่า B1 ถูกอัดมาครึ่งตัว วัดแล้วพบว่าเป็นเรื่องจริงและ
กว้างกว่าที่ทัก
...
| | ระดับ 1 | 2 | 3 | 4 |
|---|---|---|---|---|
| `beh12_hex_flat` pretrain | +0.0032 | +0.0141 | +0.0363 | +0.0775 |
| `beh12_c08f09t09_flat` held out | +0.0069 | +0.0215 | +0.0407 | +0.0863 |
| `beh12_b1_v2` คลัง | +0.0105 | +0.0268 | +0.0401 | +0.0807 |
