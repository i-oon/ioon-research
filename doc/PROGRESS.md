...
| | เดิม 15° | ใหม่ 25° + ตรึง + พื้น x3 | แมลง |
|---|---|---|---|
| เฟรมที่ตัดขอบ เฉลี่ย | 61% | **0%** | 0% |
| sd พื้นหลัง | 5.48 | **3.60** | 3.80 |
| ขอบพื้นหลังที่แรงสุด | 6.34 | **3.58** | 4.32 |
| พื้นหลังต่างกันระหว่างคลิป | 2.79 | **0.21** | 0.14 |
