...
**แต่ลูปเดียวกันควบคุมความเร็วได้เมื่อเป้าหมายเป็นหุ่นตัวเดียวกัน** `hex_c3_rep5` ผ่านเกณฑ์ 50% error
...
| | ep1 เดินหน้า | ep1300 เลี้ยว | ep2301 เดินข้าง | สุ่ม |
|---|---|---|---|---|
| world model แช่แข็ง ฟิตแค่ projector | **5%** | 5% | 38% | 33/33/17% |
| ปรับ ITM+FDM ด้วย MSE | **32%** | 9% | 29% | |
...
| | `speed_c5.8` | `turn_s0.56` |
|---|---|---|
| ปรับร่วม MSE | **32% ± 7** (25-38) | **2% ± 2** (0-5) |
| ปรับร่วม + InfoNCE | **74% ± 3** (71-77) | 32% ± 5 (28-37) |
| สุ่ม | 33% | 33% |
