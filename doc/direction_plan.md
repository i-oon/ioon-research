...
(RL controller) is blocked again by the same exhausted-fixes wall F201 had thought was cleared — no
fix currently on record clears this gate at a sample size large enough to trust.
