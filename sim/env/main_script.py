...
def sysCall_init():
    ...
    # ================= Graph (commented out: was popping up a plot window every launch) ================= #
...
def sysCall_sensing():
    ...
    # ================ graph data (commented out with the setup above) ================== #
...
def csv_to_motor():
    ...
    # print(sim.getObjectPosition(sim.getObject('/head'))[2])
