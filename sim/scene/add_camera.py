...
resize/crop guesswork that scripts/_archive/temporal_similarity_quantified.py had to
...
Usage (CoppeliaSim must already be running, see sim/SOURCES.md):
  python sim/scene/add_camera.py --scene sim/env/medauroidea_stick_insect.ttt
  python sim/scene/add_camera.py --scene sim/env/medauroidea_stick_insect_short.ttt --preview
  python sim/scene/add_camera.py --all          # do all 3 variants
"""
import argparse
import os
